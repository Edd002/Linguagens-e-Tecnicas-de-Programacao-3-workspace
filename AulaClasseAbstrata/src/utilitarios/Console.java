	...
	public static int readInt(String prompt) {
		while (true) {
			...
			try {
				...
				System.out.println("Não é um número inteiro. Favor entre novamente!");
			}
		}
	}

	/**
	 * lê um número em ponto flutuante do console. A entrada é terminada por um
	 * newline
	 * 
	 * @param prompt
	 *            a string prompt a ser exibida
	...
	public static double readDouble(String prompt) {
		while (true) {
			...
			try {
				...
				System.out.println("Não é um número em ponto flutuante. Favor entre novamente!");
			}
		}
	}
}
