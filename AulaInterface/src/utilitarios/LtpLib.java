...
public class LtpLib {
	 ...
	 *            - String com a data
	 * @param dt
	 *            referência a um objeto da classe GregorianCalendar para receber a
	 *            data válida
	 * @return true para data válida ou false para data inválida
	 */
	 ...
	 *            - String com a data
	 * @param dt
	 *            referência a um objeto da classe java.sql.Date para receber a data
	 *            válida
	 * @return true para data válida ou false para data inválida
	 */
	 ...
	 * 
	 * @param wdata
	 *            - String com a data no formato h:m:s ou hh:mm:ss
	 ...
	 *            - String com a data no formato h:m:s ou hh:mm:ss
	 * @param dt
	 *            - Objeto GregorianCalendar dt para atualizar a hora na data
	 *            corrente
	 * @return true para horário válido ou false para horário inválido
	 */
	 ...
	 * 
	 * @param wdataHora
	 *            - String com a data no formato d/M/yy h:m:s ou d/M/yyyy hh:mm:ss
	 * @return true para horário válido ou false para horário inválido
	 */
	 ...
	 *            - String com a data no formato d/M/yy h:m:s ou d/M/yyyy hh:mm:ss
	 * @param dt
	 *            - Objeto GregorianCalendar dt para atualizar a data hora
	 * @return true para horário válido ou false para horário inválido
	 */
	 ...
	 *            - String com a data no formato d/M/yy h:m:s ou d/M/yyyy hh:mm:ss
	 * @param dt
	 *            - Objeto java.sql.Date dt para atualizar a data hora
	 * @return true para horário válido ou false para horário inválido
	 */
	 ...
	 * 
	 * @param dt1
	 *            - data/hora de inicio do intervalo
	 * @param dt2
	 *            - data/hora final do intervalo
	 * @param tipoRetorno
	 *            - 1: retorna horas, 2: retorna milisegundos, 3: retorna minutos,
	 *            4: retorna segundos
	 ...
	 * 
	 * @param miliseg
	 *            - representa o horário em milisegundos
	 * @param retorno
	 *            - LtpLib.RETORNAR_SEGUNDOS ou LtpLib.RETORNAR_MILISEGUNDOS
	 ...
	 * 
	 * @param nomeArquivo
	 *            - representa o nome do arquivo em que está armazenado os objetos
	 *            da lista
	 ...
	 * 
	 * @param nomeArquivo
	 *            - representa o nome do arquivo em que será gravado os objetos da
	 *            lista
	 * @param listaObjetos
	 *            - referência para os objetos da lista controlados pela classe
	 *            Vector
	 * @throws Exception
	 *             - Exceção de java.io
	 */
